...
public class TurnRuleJUnitTest extends BaseJUnitTest {
    ...
    public void testCityStarvesOutAnotherGrows(){
		...
		game.insert(tile4);
		game.insert(player1);
		Set<CityDTO> cities = new HashSet<CityDTO>();
		cities.add(growingCity);
		cities.add(starvingCity);
		game.insertAll(cities);
		...
		System.out.println(starvingCity.getSize());
		System.out.println(starvingCity.getFoodSurplus());
		System.out.println(starvingCity.getFoodStock());
    ...
    public void testCreateSettler(){
    	...
    	CityDTO city = getCity(1L, "Brno");
    	city.setSize(3);
    	city.setPeopleContent(3);
    	city.setOwner(player.getId());
    	
    	TileDTO tile = getTile(1L, 1L, 1L, "plains", null);
    	TileDTO tile2 = getTile(2L, 1L, 2L, "forest", null);
    	TileDTO tile3 = getTile(3L, 2L, 1L, "plains", null);
    	TileDTO tile4 = getTile(4L, 2L, 2L, "plains", null);
    	
    	city.getManagedTiles().add(tile.getId());
    	city.getManagedTiles().add(tile2.getId());
    	city.getManagedTiles().add(tile3.getId());
    	city.getManagedTiles().add(tile4.getId());
